...
const isClerkNotFound = (err: any): boolean =>
    err?.status === 404 || err?.errors?.[0]?.code === "resource_not_found";
...
export const updateTeacher = async (
    ...
    try {
        ...
        try {
            ...
            console.log(`Clerk user ${data.id} not found, skipping Clerk update`);
        }
...
export const deleteTeacher = async (
    ...
    try {
        ...
        try {
            ...
            if (!isClerkNotFound(err)) throw err;
            console.log(`Clerk user ${id} not found, skipping Clerk deletion`);
        }
